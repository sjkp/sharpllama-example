...
public class KernelMemorySaveAndLoad
{
    ...
    public static async Task Run()
    {
        ...
        string modelPath = @"/Users/sjkp/projects/sharpllama-example/Meta-Llama-3-8B-Instruct-Q4_K_M.gguf";
        ...
        await AskSingleQuestion(memory, "Hvad kan du fortælle mig om tilsynsbesøg?");
    ...
    private static IKernelMemory CreateMemoryWithLocalStorage(string modelPath)
    {
        ...
        LLamaSharpConfig lsConfig = new(modelPath) { DefaultInferenceParams = infParams, GpuLayerCount = 5, ContextSize = 4096};
    ...
    private static async Task IngestDocuments(IKernelMemory memory)
    {
        string[] filesToIngest = [
                ...
                Path.GetFullPath(@"./CSRB_Review_of_the_Summer_2023_MEO_Intrusion_Final_508c.pdf"),
            ];
