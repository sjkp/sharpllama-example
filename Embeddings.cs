...
namespace LLama.Examples.Examples
{
    ...
    public class GetEmbeddings
    {
        ...
        {
            string modelPath = @"/Users/sjkp/projects/sharpllama-example/Meta-Llama-3-8B-Instruct-Q4_K_M.gguf"; // change it to your own model path.

            Console.ForegroundColor = ConsoleColor.DarkGray;
            var @params = new ModelParams(modelPath) { EmbeddingMode = true, ContextSize = 1024};
